...
public class BrightnessPrefs extends PreferenceActivity implements OnPreferenceClickListener, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	addPreferencesFromResource(Res.layout.prefs_brightness);
		...
		if (checkbox.isChecked()) {
			...
			if (hasLightSensor(this)) {
				...
				AlertDialog dialog = new AlertDialog.Builder(this)
					...
					.setTitle(Res.string.txt_brightness)
					.setMessage(Res.string.msg_enable_autobrightness)
					.setPositiveButton(Res.string.btn_yes, this)
					.setNegativeButton(Res.string.btn_no, this)
					.create();
				dialog.show();
			}
	    	...
	    	if (BrightnessSettingHandler.MODE_AUTO == mode) {
	    		...
	    		Toast.makeText(this, Res.string.txt_autobrightness_disabled, Toast.LENGTH_SHORT).show();
	    	}			
		}		
		return true;
	}
