...
public class UnlockPatternSettingHandler22 extends SettingHandler {
	...
	public void activate(MainSettingsActivity activity) throws Exception {
		...
		switch (type) {
			case TYPE_PATTERN: s.descr = getString(Res.string.txt_pattern); break;
			case TYPE_PIN: s.descr = getString(Res.string.txt_pin); break;
			case TYPE_PASS: s.descr = getString(Res.string.txt_password); break;
			default: s.descr = getString(Res.string.txt_status_disabled); break;
		}
