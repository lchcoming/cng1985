...
public enum FourGState {
	...
	TURNING_ON(Res.string.txt_status_turning_on), 
	TURNING_OFF(Res.string.txt_status_turning_off), 
	ON(Res.string.txt_status_turned_on), 
	OFF(Res.string.txt_status_turned_off), 
	UNKNOWN(Res.string.txt_status_unknown);
