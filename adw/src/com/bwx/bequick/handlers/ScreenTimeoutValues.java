...
public class ScreenTimeoutValues {
	...
	public String getDescriptionByIndex(int index) {
		...
		switch (index) {
			case 0:
			case 1:
				descr = mContext.getString(Res.string.txt_screen_timeout_value_seconds, VALUES[index]);
				break;
			case 2:
				descr = mContext.getString(Res.string.txt_screen_timeout_value_minute, VALUES[index]);
				break;
			case 3:
			case 4:
			case 5:
				descr = mContext.getString(Res.string.txt_screen_timeout_value_minutes, VALUES[index]);
				break;
			default:
				descr = mContext.getString(Res.string.txt_screen_timeout_value_never);
				break;
		}
		return descr;
	}
