...
public class VolumeDialog implements OnCancelListener, OnClickListener, OnSeekBarChangeListener, OnCheckedChangeListener {
	...
	private static final int[] TEXT_IDS = {
		Res.id.text1, Res.id.text2, Res.id.text3, Res.id.text4, Res.id.text5, Res.id.text6  
	};
	
	private static final int[] SLIDER_IDS = {
		Res.id.slider1, Res.id.slider2, Res.id.slider3, Res.id.slider4, Res.id.slider5, Res.id.slider6  
	};
	...
	public void show() {
		...
		if (dialog == null) {
			...
			dialog.setContentView(Res.layout.settings_volume_streams);
			dialog.setOnCancelListener(this);
			dialog.findViewById(Res.id.button1).setOnClickListener(this);
			dialog.findViewById(Res.id.button2).setOnClickListener(this);
			
			CheckBox checkbox = (CheckBox) dialog.findViewById(Res.id.checkbox1);
