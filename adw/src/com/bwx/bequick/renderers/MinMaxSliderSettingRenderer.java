...
public class MinMaxSliderSettingRenderer implements SettingRenderer, OnClickListener, OnSeekBarChangeListener {
	...
	public View getView(LayoutInflater inflater, Setting setting, View convertView, Context context) {
		...
		LinearLayout view = mView = (LinearLayout) inflater.inflate(Res.layout.row_setting_minmax_slider, null);
		
		// re-initialize views
		SeekBar slider = mSlider = (SeekBar) view.findViewById(Res.id.slider_view);
		mDescr = (TextView) view.findViewById(Res.id.descr_view);
		ImageButton minButton = (ImageButton) view.findViewById(Res.id.min_button);
		ImageButton maxButton = (ImageButton) view.findViewById(Res.id.max_button);
	...
	public void onStartTrackingTouch(SeekBar seekBar) {
		...
		if (popup == null) {
			...
			TextView text = mPreviewText = (TextView) mInflater.inflate(Res.layout.popup_text, null);
