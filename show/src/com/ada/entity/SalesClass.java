...
/**
 * SalesClass entity. @author MyEclipse Persistence Tools
 */

public class SalesClass implements java.io.Serializable {
	...
	/** minimal constructor */
	public SalesClass(String classId, String className, String classDesc,
