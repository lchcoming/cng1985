...
(function(NS) {
     ...
     * @param {Object} config
     */
    NS.Suggest = function(nametext,textInput, textInput1, textInput2, textInput3, textInput4, textInput5, dataSource, config) {
        /**
         * 文本输入框
         * @type HTMLElement
         */
        this.textInput = Dom.get(textInput); //材料编号
        //------------------------------------------页面的对应的输入框 START
        //Add by guxiao 2009.11.10 
        this.textInput1 = Dom.get(textInput1); //材料名称
        this.textInput2 = Dom.get(textInput2); //材料品牌
        this.textInput3 = Dom.get(textInput3); //材料规格
        this.textInput4 = Dom.get(textInput4); //材料单位
        this.textInput5 = Dom.get(textInput5); //材料单价
        this.nametext=Dom.get(nametext)
        //------------------------------------------页面的对应的输入框 END
    ...
    Lang.augmentObject(NS.Suggest.prototype, {
         ...
         * @return {HTMLElement}
         */
        formatItem: function(key, result, cailiaoPinpai, cailiaoGuige, cailiaoDanwei, cailiaoJiage) {
