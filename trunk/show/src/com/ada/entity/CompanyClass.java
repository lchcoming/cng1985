...
/**
 * CompanyClass entity. @author MyEclipse Persistence Tools
 */

public class CompanyClass implements java.io.Serializable {
	...
	/** minimal constructor */
	public CompanyClass(String classId, String className, String classDesc,
	...
	public CompanyClass(String classId, String className, String classDesc,
			...
			String rsrvStr8, String rsrvStr9, String rsrvStr10,
			Timestamp addDate) {
		this.classId = classId;
		this.className = className;
		this.classDesc = classDesc;
