...
/**
 * BpmdefinitionId entity. @author MyEclipse Persistence Tools
 */

public class BpmdefinitionId implements java.io.Serializable {
	...
	/** default constructor */
	public BpmdefinitionId() {
	}

	/** minimal constructor */
	public BpmdefinitionId(String tradeTypeCode, String bpmId, String nodeId) {
	...
	/** full constructor */
	public BpmdefinitionId(String tradeTypeCode, String bpmId, String nodeId,
			String nodeType, String nodeSequence, String nodeClass,
			String nodeMethod, String outQuery, String outBuffer,
			String undoTag, String undeClass, String undoMethod,
			String undoOutQuery, String undoOutBuffer, String rsrvStr1,
			...
			String rsrvStr0, Timestamp inDate, String remark) {
		this.tradeTypeCode = tradeTypeCode;
		this.bpmId = bpmId;
		this.nodeId = nodeId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BpmdefinitionId))
			return false;
		BpmdefinitionId castOther = (BpmdefinitionId) other;
