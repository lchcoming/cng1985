...
/**
 * ScoreModel entity. @author MyEclipse Persistence Tools
 */
...
public class ScoreModel implements java.io.Serializable {
	...
	/** minimal constructor */
	public ScoreModel(String scoreModelId, String scoreModelName,
			String scoreModelComment, String operUser, Timestamp operTime) {
	...
	/** full constructor */
	public ScoreModel(String scoreModelId, String scoreModelName,
			String scoreModelComment, Integer checked, String checkUser,
			Timestamp checkTime, String operUser, Timestamp operTime,
			Integer removeTag, String rsrvStr1, String rsrvStr2,
			String rsrvStr3, String rsrvStr4, String rsrvStr5, String rsrvStr6,
			String rsrvStr7, String rsrvStr8, String rsrvStr9,
