...
/**
 * OrderSheet entity. @author MyEclipse Persistence Tools
 */
...
public class OrderSheet implements java.io.Serializable {
	...
	/** minimal constructor */
	public OrderSheet(String orderId, String orderName, String buyerCustId,
			String buyerCustName, String saleCustId, String saleCustName,
			String price) {
	...
	public OrderSheet(String orderId, String orderName, String buyerCustId,
			String buyerCustName, String saleCustId, String saleCustName,
			Integer orderType, String price, String discount, String num,
			Float money, Timestamp deadDate, String site, String sendStyle,
			String payStyle, String buyTel, String buyAdd, String buyUser,
			String buyCode, String buyBank, String buyBankCompany,
			String buyBankCode, String saleTel, String saleAdd,
			String saleUser, String saleCode, String saleBank,
			...
			Timestamp saleInDate, String remark, String moneytype) {
		this.orderId = orderId;
		this.orderName = orderName;
		this.buyerCustId = buyerCustId;
		this.buyerCustName = buyerCustName;
