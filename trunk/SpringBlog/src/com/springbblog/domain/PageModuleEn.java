...
import com.springbblog.enums.Group;
 ...
 */
@Entity
public class PageModuleEn implements java.io.Serializable {
    ...
    // 参数定义这个PageModule在当前moduleGroup中的位置(排序)
    @SearchField
    ...
    public void setModuleGroup(Group moduleGroup) {
