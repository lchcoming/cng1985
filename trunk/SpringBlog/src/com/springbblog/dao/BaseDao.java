...
public abstract class BaseDao<T, PK extends Serializable> {
     ...
     * @return
     */
    public List<T> findAll(String sortField, Boolean asc, Integer start, Integer size) {
     ...
     * @return
     */
    public List<T> findByObject(T o, String sortField, Boolean asc, Integer start, Integer size) {
        EntityManager em = getEM();
        try {
     ...
     * @return
     */
    public Integer countByObject(T o) {
        EntityManager em = getEM();
        try {
     ...
     * @return
     */
    public List<T> convertAsArrayList(List<T> data) {
        if (data == null) {
            return null;
        }
