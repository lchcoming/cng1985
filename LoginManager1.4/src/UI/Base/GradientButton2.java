...
public class GradientButton2 extends JButton {
	private Color color1 = new Color(241,245,255);
	private Color color2 = new Color(230,238,255);
	private Color color3 = new Color(186,202,233);
	private Color color4 = new Color(237,244,255);
	private Color color5 = new Color(166,193,253);
	...
	public GradientButton2()
	{
		...
		this.addMouseListener(new MouseAdapter(){
			public void mouseEntered(MouseEvent e)
			{
				...
				color5 = new Color(133,180,8);
				fontColor = new Color(37,65,0);
			}
