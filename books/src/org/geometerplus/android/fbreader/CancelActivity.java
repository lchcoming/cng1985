	...
	private class ActionListAdapter extends BaseAdapter implements AdapterView.OnItemClickListener {
		...
		public View getView(int position, View convertView, final ViewGroup parent) {
			final View view = convertView != null
				? convertView
				: LayoutInflater.from(parent.getContext()).inflate(Res.layout.cancel_item, parent, false);
			final TextView titleView = (TextView)view.findViewById(Res.id.cancel_item_title);
			final TextView summaryView = (TextView)view.findViewById(Res.id.cancel_item_summary);
