...
public class NetworkLibraryActivity extends NetworkBaseActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		addMenuItem(menu, MENU_SEARCH, "networkSearch", Res.drawable.ic_menu_search);
		addMenuItem(menu, MENU_ADD_CATALOG, "addCustomCatalog", Res.drawable.ic_menu_add);
		addMenuItem(menu, MENU_REFRESH, "refreshCatalogsList", Res.drawable.ic_menu_refresh);
		addMenuItem(menu, MENU_LANGUAGE_FILTER, "languages", Res.drawable.ic_menu_languages);
		return true;
	}
