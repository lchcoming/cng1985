...
public abstract class LibraryBaseActivity extends BaseActivity implements MenuItem.OnMenuItemClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        addMenuItem(menu, 1, "localSearch", Res.drawable.ic_menu_search);
        return true;
    }
		...
		public View getView(int position, View convertView, final ViewGroup parent) {
			...
			if (tree instanceof ZLAndroidTree) {
				...
				if (coverBitmap != null) {
					...
					coverView.setImageResource(Res.drawable.ic_list_library_author);
				} else if (tree instanceof TagTree) {
					coverView.setImageResource(Res.drawable.ic_list_library_tag);
