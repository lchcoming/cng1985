...
public class LibraryTopLevelActivity extends LibraryBaseActivity {
	...
	public void onCreate(Bundle icicle) {
		...
		myItems.add(new TopLevelTree(
			...
			Res.drawable.ic_list_library_favorites,
