...
class ZLColorPreference extends DialogPreference implements ZLPreference {
	...
	ZLColorPreference(Context context, ZLResource resource, String resourceKey, ZLColorOption option) {
		...
		setDialogLayoutResource(Res.layout.color_dialog);
	...
	protected void onBindDialogView(View view) {
		...
		myRedSlider = createSlider(view, Res.id.color_red, color.Red, "red");
		myGreenSlider = createSlider(view, Res.id.color_green, color.Green, "green");
		myBlueSlider = createSlider(view, Res.id.color_blue, color.Blue, "blue");

		final View colorBox = view.findViewById(Res.id.color_box);
