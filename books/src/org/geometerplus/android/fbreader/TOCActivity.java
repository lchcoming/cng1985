	...
	private final class TOCAdapter extends ZLTreeAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			final View view = (convertView != null) ? convertView :
				LayoutInflater.from(parent.getContext()).inflate(Res.layout.toc_tree_item, parent, false);
			final TOCTree tree = (TOCTree)getItem(position);
			view.setBackgroundColor((tree == mySelectedItem) ? 0xff808080 : 0);
			setIcon((ImageView)view.findViewById(Res.id.toc_tree_item_icon), tree);
			((TextView)view.findViewById(Res.id.toc_tree_item_text)).setText(tree.getText());
			return view;
		}
