...
public final class FBReader extends ZLAndroidActivity {
	...
	public void onStart() {
		...
		final RelativeLayout root = (RelativeLayout)findViewById(Res.id.root_view);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		addMenuItem(menu, ActionCode.SHOW_LIBRARY, Res.drawable.ic_menu_library);
		addMenuItem(menu, ActionCode.SHOW_NETWORK_LIBRARY, Res.drawable.ic_menu_networklibrary);
		addMenuItem(menu, ActionCode.SHOW_TOC, Res.drawable.ic_menu_toc);
		addMenuItem(menu, ActionCode.SHOW_BOOKMARKS, Res.drawable.ic_menu_bookmarks);
		addMenuItem(menu, ActionCode.SWITCH_TO_NIGHT_PROFILE, Res.drawable.ic_menu_night);
		addMenuItem(menu, ActionCode.SWITCH_TO_DAY_PROFILE, Res.drawable.ic_menu_day);
		addMenuItem(menu, ActionCode.SEARCH, Res.drawable.ic_menu_search);
