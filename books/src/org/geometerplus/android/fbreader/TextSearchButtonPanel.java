...
final class TextSearchButtonPanel extends ControlButtonPanel implements View.OnClickListener {
	...
	public void createControlPanel(FBReader activity, RelativeLayout root) {
		...
		addButton(ActionCode.FIND_PREVIOUS, false, Res.drawable.text_search_previous);
		addButton(ActionCode.CLEAR_FIND_RESULTS, true, Res.drawable.text_search_close);
		addButton(ActionCode.FIND_NEXT, false, Res.drawable.text_search_next);
	}
