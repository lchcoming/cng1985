...
final class NavigationButtonPanel extends ControlButtonPanel {
	...
	public void createControlPanel(FBReader activity, RelativeLayout root) {
		...
		final View layout = activity.getLayoutInflater().inflate(Res.layout.navigate, myControlPanel, false);

		final SeekBar slider = (SeekBar)layout.findViewById(Res.id.book_position_slider);
		final TextView text = (TextView)layout.findViewById(Res.id.book_position_text);
	...
	private void setupNavigation(ControlPanel panel) {
		final SeekBar slider = (SeekBar)panel.findViewById(Res.id.book_position_slider);
		final TextView text = (TextView)panel.findViewById(Res.id.book_position_text);
