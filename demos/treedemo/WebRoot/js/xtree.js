...
function WebFXTreeAbstractNode(sDBID, sText, sAction) {
	this.childNodes  = [];
...
WebFXTreeItem.prototype.clear = function() {
	for (var i = this.childNodes.length - 1; i >= 0; i--) {
		this.childNodes[i]._remove();
 	}
}
...
function setSysPath(tree,path){
 webFXTreeConfig.setrootIcon(path+'pic/sys_xtree_foldericon.gif'); 
 webFXTreeConfig.setopenRootIcon(path+'pic/sys_xtree_openfoldericon.gif');
 webFXTreeConfig.setfolderIcon(path+'pic/sys_xtree_foldericon.gif');
 webFXTreeConfig.setfileIcon(path+'pic/sys_xtree_file.gif');
 webFXTreeConfig.setopenFolderIcon(path+'pic/sys_xtree_openfoldericon.gif');
...
function setEQPath(tree,path){
 webFXTreeConfig.setrootIcon(path+'pic/eq_xtree_foldericon.gif'); 
 webFXTreeConfig.setopenRootIcon(path+'pic/eq_xtree_openfoldericon.gif');
 webFXTreeConfig.setfolderIcon(path+'pic/eq_xtree_foldericon.gif');
 webFXTreeConfig.setfileIcon(path+'pic/eq_xtree_file.gif');
 webFXTreeConfig.setopenFolderIcon(path+'pic/eq_xtree_openfoldericon.gif');
 tree.icon=webFXTreeConfig.rootIcon;
 tree.openIcon=webFXTreeConfig.openRootIcon;
  setPath(path);
}
function setOrgPath(tree,path){
 webFXTreeConfig.setrootIcon(path+'images/org_xtree_foldericon.gif'); 
 webFXTreeConfig.setopenRootIcon(path+'images/org_xtree_openfoldericon.gif');
 webFXTreeConfig.setfolderIcon(path+'images/org_xtree_foldericon.gif');
 webFXTreeConfig.setfileIcon(path+'images/org_xtree_file.gif');
 webFXTreeConfig.setopenFolderIcon(path+'images/org_xtree_openfoldericon.gif');
 tree.icon=webFXTreeConfig.rootIcon;
 tree.openIcon=webFXTreeConfig.openRootIcon;
  setPath(path);
}
function setFilePath(tree,path){
 webFXTreeConfig.setrootIcon(path+'images/xtree_foldericon.gif'); 
 webFXTreeConfig.setopenRootIcon(path+'images/xtree_openfoldericon.gif');
 webFXTreeConfig.setfolderIcon(path+'images/xtree_foldericon.gif');
 webFXTreeConfig.setfileIcon(path+'images/xtree_file.gif');
 webFXTreeConfig.setopenFolderIcon(path+'images/xtree_openfoldericon.gif');
 tree.icon=webFXTreeConfig.rootIcon;
 tree.openIcon=webFXTreeConfig.openRootIcon;
  setPath(path);
}
