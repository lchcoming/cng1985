...
public class activeTree {
        ...
        try
        {
          if(rs.next())
          {
            ...
            if(st.hasMoreTokens())
            {
              ...
              str1=st.nextToken();
               tmp="<A target=\"" + treeTarget + "\" HREF=\"" + str1 + "\">" + str0 + "</A>";
              b=true;
            }
            else
            {
            ...
            sd.append("<UL style=\"BACKGROUND-COLOR: ; font-family: \u5B8B\u4F53; font-size: 10pt; font-weight: normal; COLOR: darkblue; MARGIN-LEFT: 5\">");
            suffix=String.valueOf(rs.getRow());
            tmp="<IMG id=limg"+suffix+" SRC=\""+home+"\">&nbsp;<SPAN id=li"+suffix+" style=\"COLOR: black; CURSOR: hand;\" LANGUAGE=javascript  onmouseover=\"return li_onmouseover(li"+suffix+")\" onmouseout=\"return li_onmouseout(li"+suffix+")\">"+tmp+"</SPAN><BR>";
            sd.append(tmp);
          ...
          while(rs.next())
          {
            ...
            if(rs.next())
            {
                  ...
                  if(lev_next==lev)
                  {
                    tmp="<IMG id=limg"+suffix+" SRC=\""+node+"\">&nbsp;<SPAN id=li"+suffix+" style=\"COLOR: black; CURSOR: hand;\" LANGUAGE=javascript  onmouseover=\"return li_onmouseover(li"+suffix+")\" onmouseout=\"return li_onmouseout(li"+suffix+")\"><IMG SRC=\""+icon+"\">"+tmp+"</SPAN><BR>";
                    sd.append(tmp);
                  }
                  if(lev_next>lev)
                  {
                    tmp="<IMG id=limg"+suffix+" SRC=\""+minus+"\" style=\"COLOR: black; CURSOR: hand;\" LANGUAGE=javascript onclick =\"return limg_onclick(li"+suffix+", d"+suffix+", limg"+suffix+")\">&nbsp;<SPAN id=li"+suffix+" style=\"COLOR: black; CURSOR: hand;\" LANGUAGE=javascript onclick =\"return li_onclick(li"+suffix+", d"+suffix+", limg"+suffix+")\" onmouseover=\"return li_onmouseover(li"+suffix+")\" onmouseout=\"return li_onmouseout(li"+suffix+")\"><IMG SRC=\""+icon+"\">"+tmp+"</SPAN><BR>";
                    sd.append(tmp);
                    tmp="<DIV id=d"+suffix+" style=\"display: block\">";
                    sd.append(tmp);
                    tmp="<UL id=u"+suffix+" style=\"MARGIN-LEFT: 0\">";
                  ...
                  if(lev_next<lev)
                  {
                    tmp="<IMG id=limg"+suffix+" SRC=\""+lastnode+"\">&nbsp;<SPAN id=li"+suffix+" style=\"COLOR: black; CURSOR: hand;\" LANGUAGE=javascript  onmouseover=\"return li_onmouseover(li"+suffix+")\" onmouseout=\"return li_onmouseout(li"+suffix+")\"><IMG SRC=\""+icon+"\">"+tmp+"</SPAN><BR>";
                    sd.append(tmp);
  ...
  public String getNewTree(ResultSet rs, String ml, String TreeName, String HomeIcon, String NodeOpenIcon,
                           String NodeCloseIcon, String ItemIcon, String Target,
        ...
        try
        {
             	...
             	if (rs.next())
             	   {
				      ...
				      sd.append("<DIV noWrap><UL style=\"MARGIN-LEFT:0\"><IMG align=\"absmiddle\" SRC=\"" + HomeIcon + "\"><SPAN><font color=red>&nbsp;&nbsp;" + 
				                tmp + "</font></SPAN>\n");
             	   }
             }
          else
          ...
          while(rs.next())
          {
            ...
            if (st.hasMoreTokens()) //�ж�ML�ֶ��Ƿ���t����Ϣ
	           {
	              str1=st.nextToken();
	              tmp="<A target=\"" + Target + "\" HREF=\"" + str1 + "\"> " + str0 + "</A>";
	              //b=true;
	           }
	        else 
	            tmp=str0;            
            ...
            if (rs.next())
	           {	                  
	                  ...
	                  if (lev_next==lev) //���յ�Ҷ�ӽڵ�
                          sd.append("<Img id=limg" + Num + " align='absmiddle' Src=\"" + ItemIcon + "\"><SPAN id=li" + 
                                    Num + " style=\"CURSOR: hand;\">  " + tmp + "</SPAN><br>");
	                  
	                  if (lev_next>lev) //�ڵ�
	                     {
		                    sd.append("<Img id=limg" + Num + " align='absmiddle' Src=\"" + NodeCloseIcon + 
		                              "\" Style=\"cursor:hand\" OnClick=\"NodeOnClick(d" + (Num + 1) + ", limg" + Num + 
		                              ")\"><SPAN id=li" + (Num + 1) + " style=\"CURSOR: hand;\" OnClick=\"NodeOnClick(d" + (Num + 1) + 
		                              ", limg" + Num + ")\">  " + (NodeLinkFlag==true ? tmp : str0) + "</SPAN><br>\n");
		                    sd.append("<DIV id=d" + (Num + 1) + " style=\"display:none\">");
		                    sd.append("  <UL id=u"+ (Num + 1) + " style=\"MARGIN-LEFT: " + 16 + "\">");
		                    count_next ++;
	                     }
	                  //*
	                  if (lev_next<lev) //��ǰ�ڵ��Ǳ������͵����һ��ڵ�
	                     {
		                    sd.append("<Img align='absmiddle' Src=\"" + ItemIcon + "\"><SPAN style=\"CURSOR: hand;\">" + 
		                              tmp + "</SPAN><br>\n");
  ...
  public String getOnlineTree(ResultSet rs, String ml, String TreeName, String HomeIcon, String NodeOpenIcon,
                           String NodeCloseIcon, String ItemIconOn,String ItemIconOff, String Target,
                           boolean NodeLinkFlag)
  {
            ...
            if (rs.next())
	           {	                  
	                  ...
	                  if(lev_next==lev)
	                     {
	                     	if (ifpost==1) //���յ�Ҷ�ӽڵ�
                             { 
                              sd.append("<Img id=limg" + Num + " align='absmiddle' Src=\"" + ItemIconOn + "\"><SPAN id=li" + 
                                    Num + " style=\"CURSOR: hand;\">  " + tmp + "</SPAN><br>");
                              }
                            else
                             {
                          	  sd.append("<Img id=limg" + Num + " align='absmiddle' Src=\"" + ItemIconOff + "\"><SPAN id=li" + 
                                    Num + " style=\"CURSOR: hand;\">  " + tmp + "</SPAN><br>");
                             }
	                     }
	                  if (lev_next>lev) //�ڵ�
	                  ...
	                  if (lev_next<lev) //��ǰ�ڵ��Ǳ������͵����һ��ڵ�
	                     {
		                    if (ifpost==1){
		                    sd.append("<Img align='absmiddle' Src=\"" + ItemIconOn + "\"><SPAN style=\"CURSOR: hand;\">" + 
		                              tmp + "</SPAN><br>\n");
		                    }else{
		                    sd.append("<Img align='absmiddle' Src=\"" + ItemIconOff + "\"><SPAN style=\"CURSOR: hand;\">" + 
		                              tmp + "</SPAN><br>\n");	
