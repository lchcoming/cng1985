...
public class UserinfoDAO implements IUserinfoDAO {
	...
	public Userinfo findById(Integer id) {
		EntityManagerHelper.log("finding Userinfo instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<Userinfo> findByProperty(String propertyName,
		...
		EntityManagerHelper.log("finding Userinfo instance with property: "
	...
	public List<Userinfo> findByUserpassword(Object userpassword,
			int... rowStartIdxAndCount) {
		return findByProperty(USERPASSWORD, userpassword, rowStartIdxAndCount);
	}

	public List<Userinfo> findByRealname(Object realname,
			int... rowStartIdxAndCount) {
		return findByProperty(REALNAME, realname, rowStartIdxAndCount);
	}
